...
SCRIPTS=(
    ...
    "franka/ee_task_unconstrained.py"
    "franka/ee_task_constrained.py"
)
...
N=2                # Number of times to run each file
BATCH_SIZE=1024     # Target batch size (nB)
DEVICE="cuda"      # Target device (cpu or cuda)

# The list of target scripts
SCRIPTS=(
    "quadrotor/mpc_forward.py"
)
